...
public class JwtUtils {
    ...
    //UWAGA: Upewnij sie, ze w application-local.properties masz: jwt.secret.key=...
    //Jesli uzywasz app.jwt.secret, zostaw jak bylo.
    @Value("${app.jwt.secret}")
    private String jwtSecret;

    //czas waznosci przepustki w milisekundach
    //samo @Value wstryzkuej nam wartosci z plikow
    @Value("${app.jwt.expiration-ms}") // Ustawiam na sztywno 24h na razie, zeby dzialalo
